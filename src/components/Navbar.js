        ...
        <div id="navbar-items" onClick={toggleMenu} className="z-10 navbar-items bg-slate-500 hidden flex items-center justify-center w-full text-center">
              <ul className='text-white text-xl md:text-3xl w-full h-fit grid grid-cols-2 justify-items-center'>
                <div className='w-full grid grid-col justify-items-center'>
                  <Link className={`p-2 m-2 hover:bg-slate-400 text-left px-2 rounded-xl w-[80%] text-sm md:text-lg ${location.pathname==='/'? "bg-slate-400" : ""}`} to="/"><li><FontAwesomeIcon icon={faHome}/> Home</li></Link>
                  <Link className={`p-2 m-2 hover:bg-slate-400 text-left px-2 rounded-xl w-[80%] text-sm md:text-lg ${location.pathname==='/about'? "bg-slate-400" : ""}`} to="/about"><li><FontAwesomeIcon icon={faCircleInfo}/> About</li></Link>
                  <Link className={`p-2 m-2 hover:bg-slate-400 text-left px-2 rounded-xl w-[80%] text-sm md:text-lg ${location.pathname==='/timeline'? "bg-slate-400" : ""}`} to="/timeline"><li><FontAwesomeIcon icon={faTimeline}/> Timeline</li></Link>
                </div>
                <div className='w-full grid grid-col justify-items-center'>
                  <Link className={`p-2 m-2 hover:bg-slate-400 text-left px-2 rounded-xl w-[80%] text-sm md:text-lg ${location.pathname==='/skills'? "bg-slate-400" : ""}`} to="/skills"><li><FontAwesomeIcon icon={faLaptop}/> Skills</li></Link>
                  <Link className={`p-2 m-2 hover:bg-slate-400 text-left px-2 rounded-xl w-[80%] text-sm md:text-lg ${location.pathname==='/projects'? "bg-slate-400" : ""}`} to="/projects"><li><FontAwesomeIcon icon={faLaptopCode}/> Projects</li></Link>
                  <Link className={`p-2 m-2 hover:bg-slate-400 text-left px-2 rounded-xl w-[80%] text-sm md:text-lg ${location.pathname==='/contact'? "bg-slate-400" : ""}`} to="/contact"><li><FontAwesomeIcon icon={faContactBook}/> Contact</li></Link>
                </div>
              </ul>
          </div>
