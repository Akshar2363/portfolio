...
import CircularProgressLogo from './CircularProgressLogo';
            ...
            <div className="skills gap-4  p-3 text-white flex flex-col items-center justify-around text-center">
              <div className="skills-section gap-4 flex flex-col w-full lg:w-[80%]">
                ...
                <div className="skills-section-body flex flex-row items-center justify-around w-full gap-3">
                    <CircularProgressLogo text={'C'} logo={CLang} percentage={80}/>
                    <CircularProgressLogo text={'C++'} logo={CppLang} percentage={75}/>
                    <CircularProgressLogo text={'Java'} logo={JavaLang} percentage={65}/>
                    <CircularProgressLogo text={'Python'} logo={Python} percentage={50}/>
              ...
              <div className="skills-section gap-4 flex flex-col w-full lg:w-[80%]">
                ...
                <div className="skills-section-body flex flex-col lg:flex-row items-center justify-center w-full gap-3 ">
                  <div className='flex flex-row items-center justify-around w-full gap-3 '>
                    <CircularProgressLogo text={'HTML'} logo={html} percentage={85}/>
                    <CircularProgressLogo text={'CSS'} logo={css} percentage={90}/>
                    <CircularProgressLogo text={'ReactJS'} logo={reactjs} percentage={75}/>
                  </div>
                  <div className='flex flex-row items-center justify-around w-full gap-3'>
                    <CircularProgressLogo text={'NodeJS'} logo={nodejs} percentage={65}/>
                    <CircularProgressLogo text={'PHP'} logo={php} percentage={70}/>
                    <CircularProgressLogo text={'JavaScript'} logo={js} percentage={75}/>
                  </div>
                </div>
              </div>
              <div className="skills-section gap-4 flex flex-col w-full lg:w-[80%]">
                ...
                <div className="skills-section-body flex flex-row items-center justify-around w-full gap-3">
                  <CircularProgressLogo text={'VS Code'} logo={vscode} percentage={95}/>
                  <CircularProgressLogo text={'Git'} logo={git} percentage={75}/>
                  <CircularProgressLogo text={'GitHub'} logo={github} percentage={75}/>
                  <CircularProgressLogo text={'Linux'} logo={linux} percentage={60}/>
                </div>
              </div>
              <div className="skills-section gap-4 flex flex-col w-full lg:w-[80%]">
                <div className="skills-section-title text-lg md:text-3xl">Databases & Frameworks</div>
                <div className="skills-section-body flex flex-row items-center justify-around w-full gap-3">
                  <CircularProgressLogo text={'MySQL'} logo={mysql} percentage={65}/>
                  <CircularProgressLogo text={'MongoDB'} logo={mongodb} percentage={55}/>
                  <CircularProgressLogo text={'Bootstrap'} logo={bootstrap} percentage={85}/>
                  <CircularProgressLogo text={'Tailwind CSS'} logo={tailwind} percentage={95}/>
                </div>
              </div>
            </div>
        </div>
