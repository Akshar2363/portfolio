...
const About = () => {
  return (
    <div className="w-full mt-[80px] ml-0 md:ml-[200px] md:mt-0">
      ...
      <div
        className={`z-10 flex flex-col justify-end md:bg-[url('${blackBg1}')] bg-[url('${blackBg2}')] backdrop-blur-xl h-[200px] lg:bg-cover bg-left text-white`}
      >
        <div className="path p-10">
          ...
          <button
            disabled
            className="bg-white rounded-xl mr-2 w-[50px] h-[10px]"
          ></button>
          <button
            disabled
            className="bg-white rounded-xl animate-pulse mr-2 w-[10px] h-[10px]"
          ></button>
          <button
            disabled
            className="bg-white rounded-xl animate-pulse mr-2 w-[10px] h-[10px]"
      ...
      <div className="text-white px-4 md:p-2 md:mx-8 flex flex-col items-center justify-between">
        <div className="w-3/6 flex flex-col justify-start items-start lg:p-4">
          <div class="grid grid-rows-3 lg:grid-flow-col gap-5">
            {/* <div class="lg:row-span-1 "></div> */}
            <div class="row-span-3 lg:flex lg:flex-col lg:my-auto lg:items-center">
            ...
            {/* <div class="lg:row-span-1 "></div> */}
            <div class="cols-span-2 row-span-3 sm:cols-span-3">
              <img
                className="aboutImg border-1 shadow-xl rounded-full border-slate-500 z-10 w-[80%] md:w-[250px] hover:scale-105 duration-500"
                src={ProfilePic}
                alt=""
              />
            </div>
        ...
        <div className="flex flex-col lg:flex-row pb-0 lg:pb-10 md:gap-4 text-sm md:text-base lg:text-lg text-slate-300 ">
          <div className="about-body p-2 lg:w-[50%] text-justify flex flex-col gap-3 ">
            <div>
              I am a promising third-year student at the prestigious
